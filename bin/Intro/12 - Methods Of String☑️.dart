void main() {
  ...
  String nameWithOutSpaces = name1.replaceAll(" " /*space*/, ""/*empty string*/);
  String nameSubString = name1.substring(0 /* start index */, 5 /* end index */);
  ...
  print(name1.compareTo(name)); // 0 if equal, 1 if greater, -1 if less
